...
The *How to: Machine Learning* tutorial series aims to go through the foundations of machine learning and the popular algorithms it is comprised of. For the applications of machine learning, see the `Advanced: Machine Learning <../advanced-applications/ml/index.html>`_ tutorial series which assumes you have the foundations under your belt.
